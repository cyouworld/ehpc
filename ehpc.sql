...
CREATE TABLE `docker_holders` (
  ...
  `using_container_count` int(11) DEFAULT '0',
...
INSERT INTO `programs` VALUES ('2', '编写MPI程序', '编写MPI程序，求小于2n的素数。\r\n\r\na)	输入：整数n，10\\<n\\<48。\r\n\r\nb)	输出：二进制文件。每个素数用一个int64_t型的整数表示，找到的全部素数按照从小到大顺序存储在输出文件中。\r\n', '0', '0', '0', '2016-12-29 23:53:40', '3', '', '0', null, null, null, null, null);
...
INSERT INTO `statistics` VALUES ('79', null, '10001', null, '2017-09-13 18:43:59');
INSERT INTO `statistics` VALUES ('80', null, '10001', null, '2017-09-13 18:44:01');
INSERT INTO `statistics` VALUES ('81', '10', '10001', null, '2017-09-13 18:44:41');
INSERT INTO `statistics` VALUES ('82', null, '10001', null, '2017-09-13 18:44:44');
INSERT INTO `statistics` VALUES ('83', '3', '10001', null, '2017-09-13 19:32:48');
...
CREATE TABLE `users` (
  ...
  `is_verify_email` tinyint(1) DEFAULT NULL,
...
INSERT INTO `users` VALUES ('3', 'teacher', 'pbkdf2:sha1:1000$ZRqJzJuR$ec4e50db6eb3eaae92e7cb8bd9468fd2743c3505', 'teacher@qq.com', '张三丰', '0', '13800138000', '中山大学', '150101102', '-1', '0', '2017-09-13 18:44:49', '2016-09-29 03:36:08', 'http://sdcs.sysu.edu.cn', '3.png?t=1489327909.05', '2', '混吃等死不舒服', '0', '4', '6', null, '0', '1', null, '113.28', '23.12', '广州', null);
...
INSERT INTO `users` VALUES ('10', 'Zouzhp', 'pbkdf2:sha1:1000$fzjFGAmb$30667cca608819c147c04d5a49671989dd66cefd', '503951764@qq.com', 'name', '1', '13800138000', 'university', '0', '-1', '1', '2017-09-13 18:44:41', '2016-12-12 10:22:07', null, '10.png?t=1481509362.88', '0', null, '0', '0', '0', null, '0', '1', null, '113.28', '23.12', '广州', null);
