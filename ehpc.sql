...
INSERT INTO `group_members` VALUES (1,1),(2,1),(3,1),(4,1),(15,1),(18,1),(19,1),(20,1),(27,1),(2,2),(16,2),(2,3),(16,3),(27,3),(1,4),(20,4),(1,6),(2,7),(15,7),(16,7),(16,9),(4,15),(27,15);
...
--
-- Table structure for table `homework_program`
--
...
--
-- Dumping data for table `homework_program`
--

LOCK TABLES `homework_program` WRITE;
/*!40000 ALTER TABLE `homework_program` DISABLE KEYS */;
/*!40000 ALTER TABLE `homework_program` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `homework_score`
--

LOCK TABLES `homework_score` WRITE;
/*!40000 ALTER TABLE `homework_score` DISABLE KEYS */;
INSERT INTO `homework_score` VALUES (3,3,88,'还有些错误！',1),(5,3,90,'下次早点交！',1);
/*!40000 ALTER TABLE `homework_score` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `homework_upload` VALUES (5,'nahan.key.zip',4,3,'course_1/homework_4/0_name_nahan.key.zip','2017-03-12 20:47:56'),(6,'2016_1【迟交】.pdf',3,3,'course_1/homework_3/150101102_张三丰_2016_1【迟交】.pdf','2017-04-10 19:00:10'),(7,'2016_2【迟交】.pdf',3,3,'course_1/homework_3/150101102_张三丰_2016_2【迟交】.pdf','2017-04-10 19:00:10'),(8,'课程介绍与安排【迟交】.pdf',3,5,'course_1/homework_3/123222222_admin_课程介绍与安排【迟交】.pdf','2017-04-17 13:29:44');
...
--
-- Table structure for table `machine_account`
--
...
--
-- Dumping data for table `machine_account`
--

LOCK TABLES `machine_account` WRITE;
/*!40000 ALTER TABLE `machine_account` DISABLE KEYS */;
/*!40000 ALTER TABLE `machine_account` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `machine_apply`
--
...
--
-- Dumping data for table `machine_apply`
--
...
INSERT INTO `notices` VALUES (12,'系统测试公告','系统测试公告\r\n系统测试公告系统测试公告系统测试公告\r\n系统测试公告\r\n系统测试公告\r\n系统测试公告系统测试公告系统测试公告','2017-06-03 19:55:27',1),(13,'第二次作业提交公告','不交作业的要挂科哈哈','2017-06-03 19:55:45',1);
...
INSERT INTO `progress` VALUES (1,5,0,'2017-03-23 09:22:38'),(1,6,0,'2017-03-22 17:50:34'),(3,5,1,'2017-07-04 21:26:21'),(3,6,0,'2017-03-24 09:15:36'),(5,5,0,'2017-03-03 13:34:55'),(10,5,0,'2017-03-22 21:07:09'),(13,5,0,'2017-03-21 16:59:38'),(15,5,0,'2017-03-25 22:09:41');
...
INSERT INTO `statistics` VALUES (1,3,10004,50001,'{\"pragram_id\": 3}','2017-07-20 10:23:39'),(2,3,10004,50001,'{\"pragram_id\": 3}','2017-07-20 11:22:10'),(3,3,10004,50001,'{\"pragram_id\": 3}','2017-07-20 13:49:47'),(4,3,10004,50001,'{\"pragram_id\": 3}','2017-07-20 13:59:57'),(5,3,10004,50001,'{\"pragram_id\": 3}','2017-07-20 14:13:05'),(6,3,10004,50001,'{\"pragram_id\": 3}','2017-07-20 14:25:52'),(7,3,10004,50001,'{\"pragram_id\": 3}','2017-07-20 14:32:21'),(8,3,10004,50001,'{\"pragram_id\": 3}','2017-07-20 14:34:32'),(9,3,10004,50001,'{\"pragram_id\": 3}','2017-07-20 14:35:22'),(10,3,10004,50001,'{\"pragram_id\": 2}','2017-07-20 15:04:53'),(11,3,10004,50002,'{\"submission_id\": 163}','2017-07-20 15:05:20'),(12,3,10004,50002,'{\"submission_id\": 164}','2017-07-20 15:05:44'),(13,3,10004,50001,'{\"pragram_id\": 2}','2017-07-20 15:06:02'),(14,3,10004,50002,'{\"submission_id\": 165}','2017-07-20 15:06:05'),(15,3,10004,50001,'{\"pragram_id\": 2}','2017-07-20 15:30:11'),(16,3,10004,50001,'{\"pragram_id\": 3}','2017-07-20 15:30:17'),(17,3,10004,50001,'{\"pragram_id\": 3}','2017-07-20 15:34:36'),(18,3,10004,50001,'{\"pragram_id\": 2}','2017-07-20 15:35:14'),(19,3,10004,50002,'{\"submission_id\": 166}','2017-07-20 15:35:16'),(20,3,10004,50001,'{\"pragram_id\": 3}','2017-07-20 15:37:52'),(21,3,10004,50001,'{\"pragram_id\": 3}','2017-07-20 15:37:57'),(22,3,10004,50001,'{\"pragram_id\": 3}','2017-07-20 15:42:24'),(23,3,10004,50001,'{\"pragram_id\": 3}','2017-07-20 15:43:30'),(24,3,10004,50001,'{\"pragram_id\": 3}','2017-07-20 15:46:39'),(25,3,10004,50001,'{\"pragram_id\": 3}','2017-07-20 15:48:41'),(26,3,10004,50001,'{\"pragram_id\": 3}','2017-07-20 16:02:33'),(27,3,10004,50001,'{\"pragram_id\": 3}','2017-07-20 16:05:42'),(28,3,10004,50001,'{\"pragram_id\": 3}','2017-07-20 16:06:48'),(29,3,10004,50001,'{\"pragram_id\": 3}','2017-07-20 16:12:14'),(30,3,10004,50001,'{\"pragram_id\": 3}','2017-07-20 16:14:28'),(31,3,10004,50001,'{\"pragram_id\": 3}','2017-07-20 16:20:10'),(32,3,10004,50001,'{\"pragram_id\": 3}','2017-07-20 16:30:57'),(33,3,10004,50001,'{\"pragram_id\": 2}','2017-07-20 16:35:58'),(34,3,10004,50002,'{\"submission_id\": 167}','2017-07-20 16:36:00'),(35,3,10004,50002,'{\"submission_id\": 168}','2017-07-20 16:36:51'),(36,3,10004,50001,'{\"pragram_id\": 3}','2017-07-20 16:39:35'),(37,3,10004,50001,'{\"pragram_id\": 3}','2017-07-20 16:43:24'),(38,3,10004,50001,'{\"pragram_id\": 3}','2017-07-20 16:46:13'),(39,3,10004,50001,'{\"pragram_id\": 3}','2017-07-20 16:48:11'),(40,3,10004,50001,'{\"pragram_id\": 3}','2017-07-20 16:49:03'),(41,3,10004,50001,'{\"pragram_id\": 3}','2017-07-20 16:51:00'),(42,3,10004,50001,'{\"pragram_id\": 3}','2017-07-20 16:51:21'),(43,3,10004,50001,'{\"pragram_id\": 3}','2017-07-20 17:55:59'),(44,3,10004,50001,'{\"pragram_id\": 3}','2017-07-20 21:20:11'),(45,3,10004,50001,'{\"pragram_id\": 3}','2017-07-20 22:23:06'),(46,3,10004,50001,'{\"pragram_id\": 3}','2017-07-20 22:25:16'),(47,3,10004,50001,'{\"pragram_id\": 3}','2017-07-20 22:29:47'),(48,3,10004,50001,'{\"pragram_id\": 3}','2017-07-20 22:31:08'),(49,3,10004,50001,'{\"pragram_id\": 3}','2017-07-20 22:33:40'),(50,3,10004,50001,'{\"pragram_id\": 3}','2017-07-20 22:34:20'),(51,3,10004,50001,'{\"pragram_id\": 3}','2017-07-20 22:36:54'),(52,3,10004,50001,'{\"pragram_id\": 3}','2017-07-20 22:38:27'),(53,3,10004,50001,'{\"pragram_id\": 3}','2017-07-20 22:59:32'),(54,3,10004,50001,'{\"pragram_id\": 3}','2017-07-20 23:02:03'),(55,3,10004,50001,'{\"pragram_id\": 3}','2017-07-20 23:06:10'),(56,3,10004,50001,'{\"pragram_id\": 3}','2017-07-20 23:07:35'),(57,3,10004,50001,'{\"pragram_id\": 3}','2017-07-20 23:17:35'),(58,3,10004,50001,'{\"pragram_id\": 3}','2017-07-20 23:18:41'),(59,3,10004,50001,'{\"pragram_id\": 3}','2017-07-20 23:20:26'),(60,3,10004,50001,'{\"pragram_id\": 3}','2017-07-20 23:21:16'),(61,3,10004,50001,'{\"pragram_id\": 3}','2017-07-20 23:25:51'),(62,3,10004,50001,'{\"pragram_id\": 3}','2017-07-20 23:27:45'),(63,3,10004,50001,'{\"pragram_id\": 3}','2017-07-20 23:28:50');
/*!40000 ALTER TABLE `statistics` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `submit_programs`
--
...
INSERT INTO `users` VALUES (1,'root','pbkdf2:sha1:1000$xBnOyGu0$2265b81c262f0438d80348748b24db1f66a65425','1291023320@qq.com','name',1,'13800138000','university','0',-1,1,'2017-03-24 09:24:17','2016-09-29 03:14:30','','1.png?t=1475844478.0',1,'知其然，知其所以然。知识广度是深度的副产品！',6,1,3,NULL,0,1,NULL),(2,'test','pbkdf2:sha1:1000$JZE0rscV$a7b07ad8602a608e76dc583142b1aaf2c378c55b','1@qq.com','name',1,'13800138000','university','0',-1,0,'2017-01-04 14:13:35','2016-09-29 03:35:29',NULL,'none.jpg',1,'好好学习，天天向上',0,0,1,NULL,0,1,NULL),(3,'teacher','pbkdf2:sha1:1000$ZRqJzJuR$ec4e50db6eb3eaae92e7cb8bd9468fd2743c3505','teacher@qq.com','张三丰',0,'13800138000','中山大学','150101102',-1,0,'2017-07-20 10:20:36','2016-09-29 03:36:08','http://sdcs.sysu.edu.cn','3.png?t=1489327909.05',2,'混吃等死不舒服',0,4,6,NULL,0,1,NULL),(4,'abc','pbkdf2:sha1:1000$Z0hb47ZO$8cc84309e6a696c6deb28d6ebb910fa828d16e3d','3@qq.com','name',1,'13800138000','university','0',-1,0,'2016-10-23 10:40:03','2016-10-17 03:00:38',NULL,'none.jpg',1,NULL,1,2,0,NULL,0,1,NULL),(5,'admin','pbkdf2:sha1:1000$h9IWWCJh$78e5c725ab15124732c7b19dbe43775df4e823e1','admin@qq.com','name',1,'13800138000','university','0',-1,0,'2017-03-23 15:23:28','2016-10-22 11:41:15',NULL,'none.jpg',0,NULL,0,0,0,NULL,0,1,NULL),(6,'wudi','pbkdf2:sha1:1000$6eg5KT1A$36731eb6b025347439f6f333050fa727f7d74d94','wudi27@mail.sysu.edu.cn','吴迪测试2',0,'13800138000','中山大学','14312412',-1,0,'2017-03-22 23:09:29','2016-10-18 02:57:55','netlab.sysu.edu.cn','6.png?t=1490195402.92',2,NULL,1,1,0,NULL,0,1,NULL),(7,'yongyi_yang','pbkdf2:sha1:1000$qeUp02pL$088fe9b296a054b622d5b3826045d9c7dbd28e9c','18826073128@163.com','name',1,'13800138000','university','0',-1,0,'2016-12-15 12:03:44','2016-10-18 15:03:29',NULL,'none.jpg',1,NULL,2,0,0,NULL,0,1,NULL),(8,'alexhanbing','pbkdf2:sha1:1000$MsiV0RcE$b9d0794fd92ce0f1d6c3432f4a68614ec60294ca','565613352@qq.com','name',1,'13800138000','university','0',-1,0,'2016-10-21 14:18:52','2016-10-21 14:18:52',NULL,NULL,1,NULL,0,3,0,NULL,0,1,NULL),(9,'forest80','pbkdf2:sha1:1000$34jYf26A$3f6f628bd4e48ed8492219171920e9d498d5023b','forest80@163.com','name',1,'13800138000','university','0',-1,1,'2016-12-05 14:04:15','2016-12-05 14:04:15',NULL,'none.jpg',1,NULL,0,0,0,NULL,0,1,NULL),(10,'Zouzhp','pbkdf2:sha1:1000$fzjFGAmb$30667cca608819c147c04d5a49671989dd66cefd','503951764@qq.com','name',1,'13800138000','university','0',-1,1,'2017-03-16 10:29:13','2016-12-12 10:22:07',NULL,'10.png?t=1481509362.88',1,NULL,0,0,0,NULL,0,1,NULL),(11,'test1','pbkdf2:sha1:1000$3fdjJ0du$b93a90b23e1365bd53962cf7339ff69d7c6e0423','test@163.com','name',1,'13800138000','university','0',-1,1,'2016-12-15 12:15:14','2016-12-15 12:15:14',NULL,'none.jpg',1,NULL,0,0,0,NULL,0,1,NULL),(12,'test_nscc','pbkdf2:sha1:1000$ANtf20qe$a3f467c203a80abde2b126307f04af5affb50164','lijianggs@126.com','name',1,'13800138000','university','0',-1,1,'2017-03-12 21:06:06','2017-01-03 15:14:08',NULL,'none.jpg',1,NULL,0,0,0,NULL,0,1,NULL),(13,'111','pbkdf2:sha1:1000$DaD5XWyO$c00d0caab874bac4e3ef1328bdcfc0408a5974b9','1970025901@qq.com','name',1,'13800138000','university','0',-1,1,'2017-03-21 16:32:50','2017-01-09 18:47:36',NULL,'none.jpg',1,NULL,0,0,0,NULL,0,1,NULL),(14,'233','pbkdf2:sha1:1000$OdRDanMv$0def1b35ce8cb669df1034d4a2c2bb1d057bbae6','50395@qq.com','name',1,'13800138000','university','0',-1,1,'2017-01-14 21:42:28','2017-01-14 21:42:28',NULL,'none.jpg',1,NULL,0,0,0,NULL,0,1,NULL),(15,'dwu','pbkdf2:sha1:1000$99UY1dEj$fe3e2848ca6be8d45783b7d2047ad83a1d38d9c8','wudi.cuhk@foxmail.com','name',1,'13800138000','university','0',-1,0,'2017-03-25 22:07:05','2017-03-05 12:22:41',NULL,'15.png?t=1490194462.8',2,NULL,0,0,0,NULL,0,1,NULL),(16,'hpc','pbkdf2:sha1:1000$AsXJJ16h$52545c65a85e4b4b1e2010ca0223bd7ebbe4d87d','hpc@qq.com','hpc',1,'0','0','0',-1,1,'2017-05-31 05:12:37','2017-05-16 07:14:30',NULL,'none.jpg',3,NULL,0,0,0,NULL,0,1,NULL);
...
INSERT INTO `vnc_knowledge` VALUES (1,'配置实验1','此乃配置实验1','upload/vnc_lab/default.png',3),(2,'配置实验2','此乃配置实验2','upload/vnc_lab/default.png',3),(3,'配置实验3','此乃配置实验3','upload/vnc_lab/default.png',3),(4,'配置实验4','此乃配置实验4','upload/vnc_lab/default.png',3);
...
-- Dump completed on 2017-07-26 17:33:43
