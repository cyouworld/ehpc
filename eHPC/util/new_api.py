...
class ehpc_client_new:
    ...
    def ehpc_run(self, output_filename, myPath, task_number, cpu_number_per_task, node_number):
        """ 在天河内部运行程序
        ...
        run_command = "srun -n %s -c %s -N %s %s" % (task_number, cpu_number_per_task, node_number, output_filename)
