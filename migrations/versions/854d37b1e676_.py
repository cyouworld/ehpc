...
Revision ID: 854d37b1e676
Revises: 4769d6d4b8dd
Create Date: 2017-05-12 15:42:05.762000

"""

# revision identifiers, used by Alembic.
revision = '854d37b1e676'
down_revision = '4769d6d4b8dd'
...
def upgrade():
    ...
    sa.Column('project_user_institution', sa.String(length=256), nullable=False),
    sa.Column('project_user_tel', sa.String(length=64), nullable=False),
    sa.Column('project_user_address', sa.String(length=256), nullable=False),
    sa.Column('project_applicant_institution', sa.String(length=256), nullable=False),
    sa.Column('project_applicant_tel', sa.String(length=64), nullable=False),
    sa.Column('project_applicant_address', sa.String(length=256), nullable=False),
    sa.Column('project_name', sa.String(length=512), nullable=False),
    sa.Column('sc_center', sa.Integer(), nullable=False),
    sa.Column('CPU_hour', sa.Integer(), nullable=False),
